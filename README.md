...
```
  ...
  git clone https://github.com/deniodev/hello-rails-front-end.git
```
...
Feel free to check the [issues page](https://github.com/deniodev/hello-rails-front-end/issues).
